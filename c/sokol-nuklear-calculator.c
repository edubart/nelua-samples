...
/* Compile command: gcc "c/sokol-nuklear-calculator.c" -o "c/sokol-nuklear-calculator" -I "/home/bart/projects/nelua/nelua-samples/libs" -Wall -fwrapv -g -Wextra -lX11 -lXi -lXcursor -ldl -lGL -lm */
/* Compile hash: fNJiuQAsuVQzmEQdiXKW1E7K6ed */
/* ------------------------------ DIRECTIVES -------------------------------- */
#ifdef __GNUC__
  #ifndef __cplusplus
...
nelua_span_uint8_ nelua_stringbuilderT_prepare(nelua_stringbuilderT_ptr self, uintptr_t n) {
  uintptr_t needed = ((self->size + n) + 1);
  ...
  return (nelua_span_uint8_){.data = ((nluint8_arr0_ptr)(&(*nelua_span_uint8____atindex((&self->data), self->size)))), .size = ((cap - self->size) - 1)};
}
...
void nelua_assert_line_4(bool cond, nlstring msg){
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/stringbuilder.nelua\033[1m:275:12: \033[31m\033[1mruntime error: \033[0m\033[1m", 1, 105, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void nelua_assert_line_5(bool cond, nlstring msg){
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/stringbuilder.nelua\033[1m:277:20: \033[31m\033[1mruntime error: \033[0m\033[1m", 1, 105, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void nelua_assert_line_6(bool cond, nlstring msg){
  if(nelua_unlikely(!cond)) {
    fwrite("/home/bart/projects/nelua/nelua-lang/lib/stringbuilder.nelua\033[1m:325:21: \033[31m\033[1mruntime error: \033[0m\033[1m", 1, 105, stderr);
    fwrite(msg.data, msg.size, 1, stderr);
...
void sokol_nuklear_calculator_calculator(NK_context_ptr ctx) {
  if((nk_begin(ctx, "Calculator", nk_rect(10.0f, 10.0f, 180.0f, 250.0f), 99U), true)) {
    bool solve = false;
    {
      ...
      nk_edit_string(ctx, 512U, (char*)(&(*nelua_span_uint8____atindex((&sb.data), 0U))), (&len), 255, nk_filter_float);
      if((len > 0)) {
        sb.size = (uintptr_t)len;
